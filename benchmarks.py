...
def transportation_cost_with_constraints(L):
    # Variables representing the number of units transported
    # L[0] = E, L[1] = F, L[2] = G, L[3] = H, L[4] = I, L[5] = J
    
    # Supply Constraints
    if (L[0] + L[1] + L[2] > 100) or (L[3] + L[4] + L[5] > 500):
        return 9999999
    
    # Demand Constraints
    if (L[0] + L[3] < 70) or (L[1] + L[4] < 80) or (L[2] + L[5] < 100):
        return 9999999
    ...
    cost = 2 * L[0] + 3 * L[1] + L[2] + 4 * L[3] + 2 * L[4] + 3 * L[5]
...
def getFunctionDetails(a):
    ...
    param = {
        ...
        "F22": ["F22", 0, 10, 4],
        "F23": ["F23", 0, 10, 4],
        "transportation_cost_with_constraints": ["transportation_cost_with_constraints", [0,0,0,0,0,0], [100,100,100,500,500,500], 6],
